    ...
    IUserRepository userRepository) : IAuthService
{
  ...
  public AuthResult Login(string Username, string Password)
  {
    ...
    {
      throw new Exception("App Service: User not found");
    }
    if(loginData.Password != Password)
    {
      throw new Exception("App Service: User incorect");
    }
      ...
      string Email)
  {
    ...
    if(authResult is not null){
      // throw new Exception ("App Service: User with the given email already exists");

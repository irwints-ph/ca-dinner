...
namespace Apps.Api.Common.Errors;
...
/// </summary>
public class AppsProblemDetailsFactory : ProblemDetailsFactory
{
    ...
    public AppsProblemDetailsFactory(
    ...
    private void ApplyProblemDetailsDefaults(HttpContext httpContext, ProblemDetails problemDetails, int statusCode)
    {
        ...
        problemDetails.Extensions.Add("CustomError","Custom Value");
